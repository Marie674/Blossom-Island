...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestGeneratorEntity : QuestEntity
    {
        ...
        public virtual void GenerateQuest()
        {
            ...
            questGenerator.GenerateQuest(this, questGroup, domainType, worldModel, requireReturnToComplete, rewardsUIContents.contentList, rewardSystems, questListContainer.questList, OnGeneratedQuest, goalSelectionMode);
            m_isGenerating = true;
        }
