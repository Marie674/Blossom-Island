...
namespace PixelCrushers.QuestMachine
{
    ...
    public class UnityUIQuestJournalUI : UnityUIBaseUI, IQuestJournalUI
    {
        ...
        [SerializeField]
        private UnityUITextTemplate m_abandonQuestNameText;
        ...
        public UnityUITextTemplate abandonQuestNameText
        {
        ...
        public void OpenAbandonQuestConfirmationDialog()
        {
            ...
            if (abandonQuestNameText != null) abandonQuestNameText.text.text = StringField.GetStringValue(selectedQuest.title);
