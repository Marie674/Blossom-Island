...
namespace CreativeSpore.RpgMapEditor
{
    ...
    public class Camera2DController : Singleton<Camera2DController>
    {


        protected Camera2DController() { }

        public Camera Camera { get; private set; }
        public SuperTilemapEditor.TilemapGroup Tilemap;
        ...
        void DoKeepInsideMapBounds()
        {
            ...
            Rect rMap = new Rect();
            rMap.width = Tilemap.SelectedTilemap.GridWidth * Tilemap.SelectedTilemap.CellSize.x;
            rMap.height = Tilemap.SelectedTilemap.GridHeight * Tilemap.SelectedTilemap.CellSize.y;
            rMap.x = Tilemap.SelectedTilemap.transform.position.x;
            rMap.y = Tilemap.SelectedTilemap.transform.position.y + rMap.height;
